...
void loadPedalParams() {
    ...
    if (err != ESP_OK) {
        ...
        nvs_get_u32(nvs_handler, "pedalPosP", (uint32_t*)(&pedalParams.position_P));
        nvs_get_u32(nvs_handler, "pedalPosI", (uint32_t*)(&pedalParams.position_I));
        nvs_get_u32(nvs_handler, "pedalPosD", (uint32_t*)(&pedalParams.position_D));
        nvs_get_u32(nvs_handler, "pedalPosRamp", (uint32_t*)(&pedalParams.ramp));
        nvs_get_u32(nvs_handler, "pedalPosLimit", (uint32_t*)(&pedalParams.limit));
...
void savePedalParams() {
    ...
    if (err != ESP_OK) {
        ...
        nvs_set_u32(nvs_handler, "pedalPosP", *(uint32_t*)(&pedalParams.position_P));
        nvs_set_u32(nvs_handler, "pedalPosI", *(uint32_t*)(&pedalParams.position_I));
        nvs_set_u32(nvs_handler, "pedalPosD", *(uint32_t*)(&pedalParams.position_D));
        nvs_set_u32(nvs_handler, "pedalPosRamp", *(uint32_t*)(&pedalParams.ramp));
        nvs_set_u32(nvs_handler, "pedalPosLimit", *(uint32_t*)(&pedalParams.limit));
