...
esp_err_t Ethernet::init(uint8_t pinMiso, uint8_t pinMosi, uint8_t pinSck, uint8_t pinCs, uint8_t pinInt, spi_host_device_t spiBus) {
    ...
    ESP_ERROR_CHECK(esp_event_handler_register(ETH_EVENT, ESP_EVENT_ANY_ID, Ethernet::eth_event_handler, NULL));
    ESP_ERROR_CHECK(esp_event_handler_register(IP_EVENT, IP_EVENT_ETH_GOT_IP, Ethernet::got_ip_event_handler, NULL)); 
